        ...
        <ul class="navbar-nav">
          ...
          <!-- <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" style="background-color: #6d111175;">
              <li><a class="dropdown-item" id="activee" href=>CUSTOMER LOGIN</a></li>
              <li><a class="dropdown-item" id="activee" href="">SUPLLIERS LOGIN</a></li>
          ...
          <div class="vid-container">
            ...
            <div class="inner-container">
              ...
              <div class="box">
                ...
                <!-- <input type="submit" value="LOGIN" style="font-family: 'montserrat';" name="bt3"/> -->
                <button style="font-family: 'montserrat';" type="submit" name="bt3"> Login</button>
                <p>Not a member? <span><a style="color: rgb(236, 146, 12);" href="./suppliers.php">SIGNUP</a></span> </p>
              </div>
                </form>
            </div>
          </div>
...
<?php
$_SESSION['name1']=$_POST['bt5'];
    if(isset($_POST['bt3']))
    {
    include "daba.php";
    $sel=mysqli_query($con,"select * from supreg where name='$_POST[bt1]' and password='$_POST[bt2]'");
