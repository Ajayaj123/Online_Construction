          ...
          <div class="div-bg">
            ...
            <form action="" method="POST">
              <div class="input-box mb-5">
                <input type="hidden" name="sender" value="contractor">
                <input type="text" name="message" class="chat-input" required=""/>
...
if($insert){
    echo '<script>window.location.href="chatbox.php";</script>;';
