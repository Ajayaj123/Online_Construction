		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="#" method="post">
					...
					<input class="text email" type="text" name="num5" placeholder="Area" required="">
					<input class="text email" type="text" name="num6" placeholder="Work" required="">
					<input class="text email" type="text" name="num7" placeholder="Details" required="">
...
$insert= mysqli_query($con,"insert into ownreg(name,contact,email,password,area,work,details) values ('$name','$youid','$mail','$pass','$are','$wrk','$det')");
if($insert){
