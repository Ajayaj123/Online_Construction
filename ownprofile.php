      ...
      <div class="container-fluid">
        ...
        >
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" id="active" href="./ownpro.php">BACK</a>
            </li>
            <!-- <li class="nav-item">
          ...
          <div class="card p-3 py-4">
            <div data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
              <div class="text-center">
                <img
                  src="./IMG_20221115_223523-modified.png"
                  width="150"
              ...
              <div class="text-center mt-2">
                ...
                <?php
                    ...
                    isset($_GET['id']);
                    $id=$_GET['id'];
                    $result = mysqli_query($con,"select * from ownreg where id='$id'");?>
                ...
                <h5 class="card-title mt1 text-capitalize">
                  <?php echo 'area: ' ?><?php echo $row['area'];?>
                    </h5>
                <h5 class="card-title mt1 text-capitalize">
                  <?php echo 'work: ' ?><?php echo $row['work'];?>
                    </h5>
                <h5 class="card-title mt1 text-capitalize">
                  <?php echo 'details: ' ?><?php echo $row['details'];?>
                    </h5>
                <h5 class="card-title mt1 text-capitalize">
                  <?php echo 'contact: ' ?><?php echo $row['contact'];?>
                    </h5>
                <h5 class="card-title mt1 text-capitalize">
                ...
                <div class="px-4 mt-2">
                  <p class="pro">
                    ...
                    please contact me and fullfilled my dreams.
                  </p>
                </div>
                <?php
                    }
