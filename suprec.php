 ...
 <div class="container-fluid">
  <div class="row py-2">
    ...
    <div class="col-lg-10 scroller">
      <?php
      $result = mysqli_query($con,"select * from supreg");
      ...
      while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
      {
        ...
        <td>".$row['cost']."</td>
        <td>".$row['discount']."</td>
        <td><button class='btn btn-success' onclick='btn()'><a href='suprec.php?id=".$row['id']."'>Delete</a></button></td>";
      }
      echo'</tr>';
      echo'</table>';?><?php
      ...
      {
        $id= $_GET['id'];
        $delete=mysqli_query($con,"DELETE FROM `supreg` WHERE `id`='$id'");
        echo '<script>window.location.href="suprec.php";</script>;';
